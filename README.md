...
- Download.js from unpkg.com (downloadjs@1.4.7)
...
yarn version:patch  # For patch version bump (1.0.6 -> 1.0.7)
# or
yarn version:minor  # For minor version bump (1.0.6 -> 1.1.0)
# or
yarn version:major  # For major version bump (1.0.6 -> 2.0.0)
```
...
yarn add github:yourcompany/draw-sign-pdf#v1.0.8
```
